...
Public Class ExhibitorPushService
    Private t As Timer
    ...
    Protected Overrides Sub OnStart(ByVal args() As String)
        ...
        t.Enabled = True
        ' t = t + New System.Timers.ElapsedEventHandler(AddressOf t_elapsed)

        t.Enabled = True
        ClassLib.WriteInTextFile("Service Started at " & System.DateTime.Now)
    End Sub
    Private Sub t_elapsed(sender As Object, e As System.Timers.ElapsedEventArgs)
        Dim m = e.SignalTime.ToShortTimeString()
        Dim a = e.SignalTime.Hour
        ClassLib.WriteInTextFile("Hour " & a)
        If a = "14" Or a = "23" Or a = "16" Or a = "17" Then
